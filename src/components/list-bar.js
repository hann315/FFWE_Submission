        ...
        <div class="row my-4">
          <div class="col-lg-6 col-sm-12 justify-content-center">
            <div class="card mb-4">
              ...
              <div class="card-body" id="coordinate">
                <h2
          ...
          <div class="col-lg-6 col-sm-12">
            <div class="card">
              ...
              <ul class="list-group list-group-flush" id="nearbyCounty"></ul>
            </div>
          </div>
        </div>
        <h4 id="titleWeather" class="my-3"></h4>
        <div class="row my-3" id="weather"></div>
      </div>`;
  }
}
